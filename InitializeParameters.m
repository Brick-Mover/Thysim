...
p(1) = 0.00174155;        %S4              ???   0.00168

p(2) = 8;                 %tau             -
p(3) = 0.868;             %k12(adults)     ?
p(4) = 0.108;             %k13(adults)     ?
p(5) = 584;               %k31free         ?
p(6) = 1503;              %k21free         ?
p(7) = 0.000289;          %A               -
p(8) = 0.000214;          %B               -
...
p(11) = 0.88;             %k4absorb;       ?
p(12) = 0.0189;           %k02             ?
p(13) = 0.00998996;       %VmaxD1fast      ?   3.85*10^(-4)
p(14) = 0.03;             %KmD1fast        ?
p(15) = 6.63*10^-4;       %VmaxD1slow      ?
p(16) = 1.0;              %KmD1slow        -

p(17) = 0.00074619;       %VmaxD2slow      ??  0.00109

p(18) = 0.075;            %KmD2slow        -

p(19) = 3.3572*10^-4;     %S3              ???  3.71*10^(-4)
...
p(36) = 23;               %K50TSH          -
p(37) = 0.118;            %k3              ?
p(38) = 0.29;             %T4P-EU(adult)   ?          
p(39) = 0.006;            %T3P-EU          ?
p(40) = 0.037;            %KdegT3B         ?
p(41) = 0.0034;           %KLAG-HYPO       ?
p(42) = 5;                %KLAG            -
p(43) = 1.3;              %k4dissolve      -
% p(44) = 0.12*d2;        %k4excrete       ?
...
T4conv  = 777/3.2; %T4 (q1) = 777/3.2 (ug/umol)/l
